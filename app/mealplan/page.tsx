                                            ...
                                            {mealPlan ? (
                                                <div className='space-y-2'>
                                                    <div className='text-black'>
                                                        <strong className='text-black'>Breakfast:</strong>{" "}
                                                        {mealPlan.Breakfast}
                                                    </div>
                                                    <div className='text-black'>
                                                        <strong className='text-black'>Lunch:</strong> {mealPlan.Lunch}
                                                    </div>
                                                    <div className='text-black'>
                                                        <strong className='text-black'>Dinner:</strong> {mealPlan.Dinner}
                                                    </div>
                                                    {mealPlan.Snacks && (
                                                        <div className='text-black'>
                                                            <strong className='text-black'>Snacks:</strong> {mealPlan.Snacks}
                                                        </div>
                                                    )}
                                                </div>
                                            ) : (
