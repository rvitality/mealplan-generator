...
const subscribeToPlan = async ({ planType, userId, email }: subscriptionType): Promise<SubscribeResponse> => {
...
export default function SubscribePage() {
    ...
    return (
        <div className='px-4 py-8 sm:py-12 lg:py-16'>
            ...
            {/* Section Header */}
            <div>
                <h2 className='text-3xl font-bold text-center mt-12 sm:text-5xl tracking-tight'>Pricing</h2>
            ...
            <div className='mt-12 container mx-auto space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8'>
                ...
                {availablePlans.map((plan: Plan, key: number) => (
                    <div
                        key={key}
                        className='
              relative p-8 
            ...
            '
                    >
                        ...
                        <button
                            ...
                            } cursor-pointer mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium disabled:bg-gray-400 disabled:cursor-not-allowed`}
