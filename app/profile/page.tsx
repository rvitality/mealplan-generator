...
export default function ProfilePage() {
    ...
    const currentPlan = availablePlans.find((plan) => plan.interval === subscription?.subscription?.subscription_tier);
    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-emerald-100 p-4'>
            <Toaster position='top-center' /> {/* Optional: For toast notifications */}
